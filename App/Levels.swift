...
/// huge runners chase at 80% of their tier's speed (55% was too tame) and
/// SHRINK + accelerate as their shield burns — from the full 42pt body down
/// to `runnerMinRadius` and up to 2× their base chase speed near death,
/// so the weaker the boss, the harder it is to hit (see applyLaserDamage).
/// Huge shooters aim slightly faster than their tier (a slow aim made them
/// trivial to kill), huge hunters approach at ~50%.
enum BossStats {
    static let radius = 42.0
    /// Near death he's runner-sized (regular runners are 14pt).
    static let runnerMinRadius = 12.0
    static let mass = 9.0
    static let patrolSpeed = 35.0
    static func runnerSpeed(tier: Int) -> Double { EnemyTiers.runnerSpeed[tier] * 0.8 }
...
struct LevelConfig {
    ...
    static let all: [LevelConfig] = [
        ...
        row(1.5, r: [0, 0, 0], s: [10, 0, 0], h: [0, 0, 0], rocks: 0, mirrors: 10, spares: [0, 0, 0], carriers: [0, 0]), // 9 · mirrors

        row(2.0, r: [0, 0, 0], s: [4, 0, 0], h: [0, 0, 0], rocks: 6, mirrors: 3, spares: [5, 0, 0], carriers: [0, 0], bosses: [BossSpec(kind: .shooter, tier: 0, shield: 14)]), // 10
        row(1.5, r: [1, 0, 0], s: [5, 0, 0], h: [0, 0, 0], rocks: 5, mirrors: 2, spares: [0, 0, 0], carriers: [0, 0]), // 11
        ...
        row(2.0, r: [4, 0, 0], s: [7, 0, 0], h: [0, 0, 0], rocks: 6, mirrors: 3, spares: [1, 0, 0], carriers: [1, 0]),
        row(2.0, r: [5, 0, 0], s: [7, 0, 0], h: [0, 0, 0], rocks: 0, mirrors: 12, spares: [1, 0, 0], carriers: [1, 0]), // 19 · mirrors

        row(2.0, r: [0, 0, 0], s: [5, 0, 0], h: [0, 0, 0], rocks: 6, mirrors: 4, spares: [0, 3, 0], carriers: [0, 0], bosses: [BossSpec(kind: .runner, tier: 0, shield: 16)]), // 20
        ...
        row(2.5, r: [5, 0, 0], s: [3, 0, 0], h: [3, 0, 0], rocks: 9, mirrors: 5, spares: [1, 0, 0], carriers: [1, 0]),
        row(2.5, r: [5, 0, 0], s: [3, 0, 0], h: [3, 0, 0], rocks: 0, mirrors: 14, spares: [1, 0, 0], carriers: [1, 0]), // 29 · mirrors
        ...
        row(2.5, r: [4, 4, 0], s: [3, 0, 0], h: [2, 0, 0], rocks: 11, mirrors: 7, spares: [0, 1, 0], carriers: [2, 1]),
        row(2.5, r: [4, 5, 0], s: [3, 0, 0], h: [2, 0, 0], rocks: 0, mirrors: 16, spares: [0, 1, 0], carriers: [2, 1]), // 39 · mirrors
